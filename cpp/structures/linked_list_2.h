...
void structures::LinkedList<T>::invert() {
    ...
    if (empty()) {
        ...
        throw std::out_of_range("lista unitária");
    } else {
...
structures::LinkedList<T>::halve() {
    ...
    /*LinkedList<T> even, odd, *peven, *podd;
    ...
    peven = &even;
    podd = &odd;
    list_halve.push_front(peven);
    list_halve.push_back(podd);*/
